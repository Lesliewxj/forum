			...
			<div class="register">
				<form action="user_Register.action" method="post"
					...
					<table style="font-size: 18px;">
						...
						<tr><td></td><td style="font-size: 12px;height: 30px;line-height: 30px;">点击注册表示您同意并愿意遵守chen-Java<a style="color: red" target="_blank" href="./secret.jsp">隐私政策</a></td><td></td></tr>
					</table>
				</form>
			</div>
